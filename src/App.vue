    ...
    >
      <div class="relative h-screen bg-slate-900 w-11/12 md:w-10/12 lg:w-9/12 overflow-y-auto scroll-smooth p-[1rem] sm:p-[3.5rem] rounded-lg">
        ...
        <article class="prose prose-sm xs:prose-base prose-headings:text-mythmatch-100 prose-p:text-stone-100 prose-blockquote:text-slate-400 prose-li:marker:text-stone-100  prose-li:text-stone-100 prose-a:text-slate-200 prose-hr:bg-slate-600 max-w-none">
          ...
          <img src="/manual/challenge.webp" alt="challenge">
          <ol>
            ...
            <li><b>Level Up!</b> Clear all pairs before time runs out, and you'll be whisked away to a new level, where your memory will be further challenged.
              <img src="/manual/level.webp" alt="level up">
            </li>
            <li><b>Gridlock Alert!</b> If the board fills up (12 pairs), the tension rises with a red background. While you won't get extra time for correct matches, keep scoring those points!
              <img src="/manual/red.webp" alt="red">
            </li>
          ...
          <img src="/manual/combo.webp" alt="combo">
          ...
          <img src="/manual/versus.webp" alt="versus">
